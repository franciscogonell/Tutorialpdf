...
//Establecer filtro
file_get_contents('https://script.google.com/macros/s/AKfycbz3Vl0nph9tkHeq6vDsWoypdsyHL2zq1BYuOEclvtnGnYgAlXMq/exec?apiKey=123456&operation=GetTickers&sheetid='.$s.'&nominaid='.$n.'&locid='.$loc.'', false, stream_context_create($arrContextOptions));
...
$locacion=$data_array->records[0]->locacion;
...
$nomina[$x] = array('codigo'=> $data_array->records[$x]->ticker, 'name'=>$data_array->records[$x]->name, 'valor'=> $totalbruto);
