...
//untitle2.
//Colocar email locacion
file_get_contents('https://script.google.com/macros/s/AKfycbxGnO8m6I4IlgX0ZHpfSvqavtjsBdqBdVQOT9PvgFm31CnTCG4e/exec?apiKey=123456&operation=GetTickers&email='.$e.'');


$Proveedor= file_get_contents('https://script.google.com/macros/s/AKfycbyuHoRAjyxrcE2tiGZ_sJhc_qHtCN4v416kDGWRC4qR2g_ro9k/exec?apiKey=1234fx&operation=GetTickers');
...
//Asignar Proveedor
$bu=file_get_contents('https://script.google.com/macros/s/AKfycbzHmXeKRo-NT12Pl9ko-Ypo6zf8MN5VY7rQBn94rnaYaI59i_c/exec?apiKey=123456&operation=GetTickers&id='.$init.'&email='.$e.'');

$noper=123;

//sleep for 5 seconds
//usleep(20000000);
$cuerpoJSON = file_get_contents('https://script.google.com/macros/s/AKfycbyPEpmTmDtf7Wt6RoeXEZuszV5YIPOC-32fnlW-ulA-PmJTofd-/exec?apiKey=123456&operation=GetTickers&operkey='.$noper.'&id='.$init.'');
...
for ($x =0; $x <= $matches; $x++) {
  ...
  <header class="clearfix">
                   ...
                   <h1>RECEPCION DE FRUTA POR EMPACADORA</h1>
